...
export default function ProductsClientPage() {
  ...
  if (loading) {
    return (
      <div className="px-4 sm:px-6 py-8 container mx-auto w-full space-y-8">
        ...
        <div className="bg-gray-900/60 border border-purple-200 dark:border-purple-900/50 rounded-xl p-6 sm:p-8 shadow-lg">
  ...
  return (
    <div className="px-4 sm:px-6 py-8 container mx-auto w-full space-y-8">
      ...
      <div className="bg-gray-900/60 border border-purple-200 dark:border-purple-900/50 rounded-xl p-6 shadow-lg">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className="pl-10 bg-gray-900 border-purple-300 dark:border-purple-500/30 text-white placeholder-gray-500 dark:placeholder-gray-400"
            />
          </div>
          
          {/* Lokasi Filter */}
          <Select value={selectedLokasi} onValueChange={setSelectedLokasi}>
            <SelectTrigger className="bg-gray-900 border-purple-300 dark:border-purple-500/30 text-white">
      ...
      <div className="bg-gray-900/60 border border-purple-200 dark:border-purple-900/50 rounded-xl overflow-x-auto shadow-lg">
                ...
                <TableCell className="text-gray-300 py-4 max-w-[120px] truncate">
                  {product.videoLink ? (
                    <a 
                      ...
                      className="text-purple-400 hover:text-purple-800 dark:hover:text-purple-300 underline truncate block"
                    >
                      View Video
                    </a>
                  ) : (
