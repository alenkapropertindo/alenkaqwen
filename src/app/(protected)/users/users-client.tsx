  ...
  if (loading) {
    return (
      <div className="px-8 py-16 container mx-auto max-w-screen-lg space-y-8">
        ...
        <div className="bg-gray-900/60 border border-purple-200 dark:border-purple-900/50 rounded-xl p-8 shadow-lg">
      ...
      <div className="bg-gray-900/60 border border-purple-200 dark:border-purple-900/50 rounded-xl p-4 sm:p-6">
        <div className="mb-6">
          <Input
            ...
            className="bg-gray-900 border-purple-300 dark:border-purple-900/50 text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-purple-500 focus:border-purple-500"
          />
        </div>
            ...
            <Table className="w-full">
              <TableHeader>
                <TableRow className="border-purple-200 dark:border-purple-900/50 hover:bg-purple-50 dark:hover:bg-gray-800">
                  <TableHead 
                    className="text-purple-200 text-sm sm:text-lg font-semibold cursor-pointer hover:text-purple-900 dark:hover:text-purple-100"
                ...
                {filteredAndSortedUsers.map((user) => (
                  <TableRow key={user.id} className="border-purple-100 dark:border-purple-900/30 hover:bg-purple-50 dark:hover:bg-gray-800/50">
                    ...
                    <TableCell className="text-gray-300 py-4">
                      ...
                      >
                        <SelectTrigger className="bg-gray-900 border-purple-300 dark:border-purple-500/50 text-white w-[120px]">
